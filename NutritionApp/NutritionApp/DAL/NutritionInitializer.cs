...
namespace NutritionApp.DAL
{
    public class NutritionInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<NutritionContext>
    {
        protected override void Seed(NutritionContext context)
        {
          ...
          new Product {  FoodId = 1,  Quantity = 65, Weight = 2, },
          new Product { FoodId = 2,  Quantity = 25, Weight = 8, },
          new Product { FoodId = 3,  Quantity = 65, Weight = 9, },
          new Product {  FoodId = 4,  Quantity = 65, Weight = 3, },
          new Product {  FoodId = 5,  Quantity = 65, Weight = 19, },

    };

            menu.ForEach(s => context.WareHouse.Add(s));
            context.SaveChanges();
        }
